...
namespace SoccerStats.Data.Migrations
{
    ...
    [Migration("20191220102419_changedexportmoments")]
    partial class changedexportmoments
    {
            ...
            modelBuilder.Entity("SoccerStats.Domain.Entities.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HomeGoals = 1,
                            HomeTeam = true,
                            MatchDate = new DateTime(2019, 12, 13, 11, 24, 18, 485, DateTimeKind.Local).AddTicks(9756),
                            TeamId = 1
                        });
                });
